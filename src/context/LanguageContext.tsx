...
export const uiTexts = {
    ...
    // 테스트 이름
    tetoVsEgen: { ko: "테토 vs 에겐", en: "TETO vs EGEN", zh: "TETO vs EGEN", ja: "テト vs エゲン" },
    sleepAnalysis: { ko: "수면 분석", en: "Sleep Analysis", zh: "睡眠分析", ja: "睡眠分析" },
    ...
    // 결과 타입
    tetoTitle: { ko: "강렬한 리더, 테토", en: "Intense Leader, TETO", zh: "强烈的领导者，TETO", ja: "強烈なリーダー、テト" },
    ...
    egenTitle: { ko: "섬세한 감성, 에겐", en: "Delicate Soul, EGEN", zh: "细腻的感性，EGEN", ja: "繊細な感性、エゲン" },
