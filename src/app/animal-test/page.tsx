...
export default function AnimalTestPage() {
  ...
  const handleSaveImage = async () => {
    ...
    const traitsHtml = (result.traits[lang] || result.traits.en)
      .map(t => `<span style="display: inline-block; padding: 6px 14px; margin: 4px; background: ${accentColor}22; color: ${accentColor}; border-radius: 20px; font-size: 13px; border: 1px solid ${accentColor}44;">${t}</span>`)
      .join('');
