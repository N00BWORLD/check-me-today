                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                            <h3 className="text-base font-bold text-slate-400 dark:text-slate-500 truncate">
                                {name}
                            </h3>
                            <span className="shrink-0 px-2 py-0.5 bg-slate-100 dark:bg-slate-800 rounded text-[10px] font-bold text-slate-400 dark:text-slate-500">
                                SOON
                            </span>
                        </div>
    ...
    return (
        <Link href={`/${test.slug}`} className="block group">
            ...
            `}>
                ...
                <div className={`
                    absolute inset-0 bg-gradient-to-br ${test.bgGradient}
                ...
                <div className="relative z-10 flex items-center gap-4">
                    ...
                    `}>
                        <span className="text-2xl filter drop-shadow-md">{test.emoji}</span>
                    </div>

                    {/* Content */}
                    <div className="flex-1 min-w-0">
                        <h3 className="text-base font-bold text-slate-800 dark:text-slate-100 mb-0.5 truncate group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 transition-colors">
                            {name}
                        </h3>
                        ...
                        {/* Stats */}
                        <div className="flex items-center gap-3 text-[11px] text-slate-500 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-400 transition-colors">
                    ...
                    {/* Arrow */}
                    <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-700/50 flex items-center justify-center shrink-0 group-hover:bg-gradient-to-r group-hover:from-purple-500 group-hover:to-pink-500 group-hover:text-white transition-all duration-300">
                        <svg
