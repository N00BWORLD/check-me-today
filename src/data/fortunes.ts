...
// 세부 운세별 코멘트
export const fortuneComments = {
  wealth: {
    1: { ko: "지출 주의", en: "Watch spending", zh: "注意开支", ja: "支出注意" },
    2: { ko: "절약이 필요해요", en: "Save wisely", zh: "需要节约", ja: "節約が必要" },
    3: { ko: "안정적인 흐름", en: "Stable flow", zh: "稳定的流动", ja: "安定した流れ" },
    4: { ko: "기회가 올 수 있어요", en: "Opportunity ahead", zh: "机会可能来临", ja: "チャンスあり" },
    5: { ko: "횡재 가능성!", en: "Windfall possible!", zh: "可能有意外之财！", ja: "思わぬ収入も！" },
  },
  love: {
    1: { ko: "혼자만의 시간도 괜찮아요", en: "Solo time is okay", zh: "独处时光也不错", ja: "一人の時間も大切" },
    2: { ko: "조금 기다려보세요", en: "Wait a little", zh: "稍微等待一下", ja: "少し待ってみて" },
    3: { ko: "평온한 관계 유지", en: "Peaceful relationship", zh: "平稳的关系", ja: "穏やかな関係" },
    4: { ko: "설레는 일이 생길지도", en: "Excitement coming", zh: "可能有心动的事", ja: "ドキドキすることが" },
    5: { ko: "사랑이 넘치는 날!", en: "Love is in the air!", zh: "充满爱的一天！", ja: "愛に溢れる日！" },
  },
  health: {
    1: { ko: "충분한 휴식 필요", en: "Need good rest", zh: "需要充分休息", ja: "十分な休息を" },
    2: { ko: "컨디션 관리하세요", en: "Manage your condition", zh: "注意身体状态", ja: "体調管理を" },
    3: { ko: "무난한 상태", en: "Doing okay", zh: "状态还可以", ja: "まあまあの状態" },
    4: { ko: "에너지가 넘쳐요", en: "Full of energy", zh: "精力充沛", ja: "エネルギー満タン" },
    5: { ko: "최상의 컨디션!", en: "Peak condition!", zh: "最佳状态！", ja: "最高のコンディション！" },
  },
  work: {
    1: { ko: "무리하지 마세요", en: "Don't overdo it", zh: "不要勉强", ja: "無理しないで" },
    2: { ko: "기본에 충실하세요", en: "Stick to basics", zh: "注重基础", ja: "基本に忠実に" },
    3: { ko: "순조로운 진행", en: "Smooth progress", zh: "进展顺利", ja: "順調な進行" },
    4: { ko: "성과가 보일 거예요", en: "Results will show", zh: "会看到成果", ja: "成果が見えそう" },
    5: { ko: "대성공 예감!", en: "Big success ahead!", zh: "大成功预感！", ja: "大成功の予感！" },
  },
};
